...
const Day8_2 = () => {
  ...
  const handleNext = async () => {
    ...
    const fetchData = async () => {
      await axios({
        method: "get",
        url: `/api/training/training-progress?employeeID=${cookies.employeeid}&day=8&part=2`,
        timeout: 5000, // 5 seconds timeout
        headers: {},
      }).then(async response => {
            ...
            if (result2.length == 0) {
              ...
              await axios({
                ...
                if (data[0].customStatusId != "IEACA7BEJMCIU22C") {
                  ...
                  await axios({
                    method: "post",
                    url: `/api/training/email-sender-day8_2`,
                    timeout: 5000, // 5 seconds timeout
                    headers: {},
                    data: {
                      username: cookies.username,
          ...
          <Box sx={{ width: "100%" }}>
            <Grid container>
              ...
              <Grid item xs={4} style={{ height: "90vh", overflow: "auto" }}>
                ...
                >
                  <div style={{ padding: "1%" }}>
                    <h2 className="title-day">Day 8 Part 2</h2>
                    <h3
                      style={{
                        color: "#fcfaf8",
                        fontWeight: "400",
